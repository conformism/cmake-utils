...
foreach( UTIL ${CMAKE_UTILS} )
	if( NOT UTIL MATCHES CLANG_BUILD_ANALYZER
	AND NOT UTIL MATCHES CLANG_FORMAT
	AND NOT UTIL MATCHES CLANG_TIDY
	AND NOT UTIL MATCHES CODECHECKER
	AND NOT UTIL MATCHES COVERAGE
	AND NOT UTIL MATCHES CPPCHECK
	AND NOT UTIL MATCHES DOXYGEN
	AND NOT UTIL MATCHES ICON
	AND NOT UTIL MATCHES IWYU
	AND NOT UTIL MATCHES LATEX
	AND NOT UTIL MATCHES LIBFUZZER
	AND NOT UTIL MATCHES LIZARD
	AND NOT UTIL MATCHES SANITIZERS
	AND NOT UTIL MATCHES UNCRUSTIFY
		)
		message( WARNING "Unknown CMake util : ${UTIL}" )
	endif()
	...
	if( UTIL MATCHES COVERAGE )
		...
		option( COVERAGE_ERROR "Abort on unittest error" ON )
	endif()
	if( UTIL MATCHES DOXYGEN )
		option( DOXYGEN_MCSS "Enable m.css Doxygen reports" OFF )
		set( MCSS_VERSION "" CACHE STRING "M.CSS git tag" )
	endif()
	if( UTIL MATCHES LATEX )
		option( LATEX_VERBOSE "Show LaTeX compiler output messages." OFF )
	endif()
